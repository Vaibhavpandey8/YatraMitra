...
import EditBusImage from "../Components/pages/AddNewBus/EditBusImage";
import EditProfile from "../Components/pages/Profile/edit";
import ViewProfile from "../Components/pages/Profile/view";
...
const MainRouter = () => (
  <Switch>
    ...
    <PrivateRoute path="/edit-bus-image/:slug" exact component={EditBusImage} />
