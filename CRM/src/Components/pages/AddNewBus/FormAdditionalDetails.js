      ...
      <Layout title="Add new bus (Additional details)">
        ...
        <div className="form-group">
          ...
          >
            ...
            {values.locations.filter(location => location._id !== values.endLocation).map(location => (
        ...
        <div className="form-group">
          ...
          >
            ...
            {values.locations.filter(location => location._id !== values.startLocation).map(location => (
              <option value={location._id} key={location._id}>
                {location.name}
              </option>
            ))}
