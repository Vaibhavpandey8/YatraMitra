...
import { removeBus, getAllUnavailableBuses, removeAllBuses } from "../../../Utils/Requests/Bus";
        ...
        <div className="d-flex" id="wrapper">
          <div id="page-content-wrapper">
            <div className="container-fluid">
              ...
              <button
                className="btn btn-outline-danger float-right mt-3 mr-2"
                onClick={this.deleteAllRecords}
                disabled={this.state.buses.length === 0}
              >
                Delete All Buses
              </button>
